...
--
-- Table structure for table `advzhanban`
--

DROP TABLE IF EXISTS `advzhanban`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `advzhanban` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `desc` text NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `advzhanban`
--

LOCK TABLES `advzhanban` WRITE;
/*!40000 ALTER TABLE `advzhanban` DISABLE KEYS */;
INSERT INTO `advzhanban` VALUES (1,'普通定时切换展板','此项目来自网上搜集。此种展板虽然普通，但很多软件都在使用，能够基本满足人们对展板的需求。','2015-08-12 21:13:10','puTongDS.html','putongDS.png'),(2,'简单定时切换展板','此项目来自网上搜集。此种展板实现原理有些简单，故效果不太理想，但我们仍然可以借鉴一下它的实现方式。','2015-08-14 07:32:19','jianDanDS.html','jiandanDS.png'),(3,'定时切换展板','此项目来自网上搜集。本项目的效果介于简单定时切换展板和普通定时切换展板之间。','2015-08-14 07:54:00','dingShiZhanBan.html','dsqhzhanban.png'),(4,'镜像特效','此项目来自网上搜集。本项目具有很好的viewPager视图切换效果。炫丽的镜像和切换效果是本项目的一大亮点。','2015-08-14 08:03:41','jingXiangTeXiao.html','jingxiangtexiao.png'),(5,'炫酷画廊一','本项目来自网上搜集。炫酷一直是人们追求的对象，所以炫酷的画廊一定会给你们留下深刻的印象。','2015-08-14 08:41:51','xuanKuHuaLang1.html','xuankuhualang1.png'),(6,'炫酷画廊二','本项目来自网上搜集。炫酷一直是人们追求的对象，所以炫酷的画廊一定会给你们留下深刻的印象。','2015-08-14 08:41:52','xuanKuHuaLang2.html','xuankuhualang2.png'),(7,'炫酷画廊三','本项目来自网上搜集。炫酷一直是人们追求的对象，所以炫酷的画廊一定会给你们留下深刻的印象。','2015-08-14 08:42:46','xuanKuHuaLang3.html','xuankuhualang3.png'),(8,'炫酷画廊四','本项目来自网上搜集。炫酷一直是人们追求的对象，所以炫酷的画廊一定会给你们留下深刻的印象。','2015-08-14 08:42:47','xuanKuHuaLang4.html','xuankuhualang4.png');
/*!40000 ALTER TABLE `advzhanban` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `gaofang`
--

DROP TABLE IF EXISTS `gaofang`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gaofang` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `desc` text NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `gaofang`
--

LOCK TABLES `gaofang` WRITE;
/*!40000 ALTER TABLE `gaofang` DISABLE KEYS */;
INSERT INTO `gaofang` VALUES (1,'仿网易布局','本项目来自网上搜集。刚进入程序的界面就给人一种充实的感觉。listview的排版比较清晰，广告板也比较有特色。','2015-08-12 21:13:10','fangWangYi.html','fangwangyi.png'),(2,'高仿茶百科','本项目来自网上搜集。此项目与其他项目有明显的区别，它本身只是一个客户端，如果不联网，就是一个空壳。服务端始终都在允行。','2015-08-13 21:04:11','chaBaiKe.html','chabaike.png'),(3,'高仿京东商城','本项目来自网上搜集。高仿京东商城同样以viewPager作为框架。此项目最大的特点就是界面美观，广告展板模块效果极佳。','2015-08-13 21:04:11','jingDongSC.html','jingdongsc.png'),(4,'开心网','本项目来自网上搜集。开心网的界面让人耳目一新，炫丽的界面让人联想到强大的功能，然而实际上功能并没有我们想象的那么强大。','2015-08-13 21:04:11','kaiXinWang.html','kaixinwang.png'),(5,'仿天天动听','本项目来自网上搜集。本项目算是一款比较成熟的音乐播放器，虽然与大型的音乐播放器相比简单了一些，但是基本功能都得以很好的实现。','2015-08-13 21:04:55','tianTianDongTing.html','tiantiandongting.png');
/*!40000 ALTER TABLE `gaofang` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hfuwuduan`
--

DROP TABLE IF EXISTS `hfuwuduan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hfuwuduan` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `desc` text NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `hfuwuduan`
--

LOCK TABLES `hfuwuduan` WRITE;
/*!40000 ALTER TABLE `hfuwuduan` DISABLE KEYS */;
INSERT INTO `hfuwuduan` VALUES (1,'糗事百科','此项目来自网上搜集。糗事百科是一款非常优秀的项目。它使用php作为后台的开发语言，对刚接触后台的开发者来说无疑是学习的优秀样本。','2015-08-12 21:13:10','qiuShiBaiKe.html','qiushibaike.png'),(2,'心情驿站','此项目来自网上搜集。本项目是一个仿QQ空间的安卓项目源码，包括Android客户端，使用SSM框架的服务端、mysql数据库。','2015-08-13 18:11:01','xinQingYiZhan.html','xinqingyizhan.jpg'),(3,'大众点评','此项目来自网上搜集。大众点评与糗事百科一样使用php作为后台开发的语言，也是不可多得的学习模版。','2015-08-13 18:38:10','daZhongDianPing.html','dazhongdianping.png');
/*!40000 ALTER TABLE `hfuwuduan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `listview` VALUES (1,'Android侧滑删除ListView','大家都知道手机QQ的会话列表有测滑删除的功能,那么这个功能究竟是怎样实现的？我从网上搜集了一套可以在eclipse中直接运行的源码分享给大家。','2015-08-12 21:13:10','ceHuaShanChuListView.html','cehuashanchu.png'),(2,'三级列表','此项目来自网上搜集。虽然在大多数情况下，我们使用二级列表多一些，比如，QQ的好友列表。但在有些时候也避免不了使用三级菜单。','2015-08-13 11:10:45','sanJiLieBiao.html','tree.png'),(3,'二级列表','此项目来自网上搜集。在实际开发中，我们会经常用到ExpandableListView这种二级列表，这种列表格式固定，易于学习。','2015-08-13 11:43:19','erJiLieBiao.html','erjiliebiao.png'),(4,'列表item贴顶效果','此项目来自网上搜集。我们在使用QQ时不难发现，即使一个分组的好友比较多，上滑列表时，也不会把分组的头部信息滑出屏幕。普通的ExpandableListView是做不到这一点的！','2015-08-13 12:07:15','tieDing.html','tieding.gif');
/*!40000 ALTER TABLE `listview` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `qinglituijian`
--

DROP TABLE IF EXISTS `qinglituijian`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qinglituijian` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `desc` text NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `qinglituijian`
--

LOCK TABLES `qinglituijian` WRITE;
/*!40000 ALTER TABLE `qinglituijian` DISABLE KEYS */;
INSERT INTO `qinglituijian` VALUES (1,'精品课程','精品课程是由山东师范大学信息科学与工程学院大二学生在刚接触安卓时开发的一个助学项目。','2015-08-12 21:13:10','jingPinKeCheng.html','jingpinkecheng.bmp');
/*!40000 ALTER TABLE `qinglituijian` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `quser` WRITE;
/*!40000 ALTER TABLE `quser` DISABLE KEYS */;
INSERT INTO `quser` VALUES (1,'lushun','20170326174041.png','',NULL,NULL,NULL,'2015/08/17',NULL,'213344','1'),(2,'weidan','weidan.png',NULL,NULL,NULL,NULL,'2015/08/17',NULL,'213344','1'),(3,'luqing','luqing.png',NULL,NULL,NULL,NULL,'2015/08/17',NULL,'213344','1'),(4,'程序员','',NULL,NULL,NULL,NULL,NULL,NULL,'213344','1'),(5,'工程师','user2.png',NULL,NULL,NULL,NULL,NULL,NULL,'213344','1'),(6,'张德磊','zhangdelei.png',NULL,NULL,NULL,NULL,NULL,NULL,'213344','1'),(7,'梦想追求者','user4.png',NULL,NULL,NULL,NULL,NULL,NULL,'213344','1'),(8,'王思雨','user5.png',NULL,NULL,NULL,NULL,NULL,NULL,'213344','1'),(9,'Archer','user.png',NULL,NULL,NULL,NULL,'2015/08/18',NULL,'254811','1'),(10,'','user.png',NULL,NULL,NULL,NULL,'2017/03/12',NULL,'','1'),(11,'lushun1','user.png',NULL,NULL,NULL,NULL,'2017/03/15',NULL,'213344','1'),(12,'lush','user.png',NULL,NULL,NULL,NULL,'2017/03/17',NULL,'213344','1'),(13,'lushun01','user.png',NULL,NULL,NULL,NULL,'2017/03/17',NULL,'213344','1'),(14,'lushun02','20170317042404.png',NULL,NULL,NULL,NULL,'2017/03/17',NULL,'213344','1'),(15,'金立','user.png',NULL,NULL,NULL,NULL,'2017/03/17',NULL,'gg','1'),(16,'lushun','20170317080512.png',NULL,NULL,NULL,NULL,'2015/08/17',NULL,'213344','1'),(17,'wenfenglong','user.png',NULL,NULL,NULL,NULL,'2017/03/23',NULL,'213344','1'),(18,'wenfenglong1','user.png',NULL,NULL,NULL,NULL,'2017/03/23',NULL,'213344','1'),(19,'lushun5','user.png',NULL,NULL,NULL,NULL,'2017/03/25',NULL,'213344','1'),(20,'lushun6','user.png',NULL,NULL,NULL,NULL,'2017/03/25',NULL,'213344','1'),(21,'lushun7','user.png',NULL,NULL,NULL,NULL,'2017/03/25',NULL,'213344','1');
/*!40000 ALTER TABLE `quser` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `qvalue`
--

DROP TABLE IF EXISTS `qvalue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `qvalue` (
  ...
  `QLIKE` int(50) NOT NULL DEFAULT '0',
  `QUNLIKE` int(50) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `qvalue`
--

LOCK TABLES `qvalue` WRITE;
/*!40000 ALTER TABLE `qvalue` DISABLE KEYS */;
INSERT INTO `qvalue` VALUES (1,1,1,'','','亲爱的酷爱安卓用户你们好，我是这款app的开发者鲁顺，现在是山东师范大学的一名大二学生。我特别喜欢安卓，自我接触它的那天起，它几乎每天都与我为伴，其实我接触安卓也就一年的时间！<br/>这个项目的开发周期为一个月，开发这个项目，主要是为了参加齐鲁软件设计大赛，然而它的意义绝非参加大赛这么简单。一方面，从中我熟练了开发项目的各种方法与技巧，另一方面也是为了给刚接触安卓的同学们搭建一个学习的平台。<font color=\"#ff0000\">给大家提供基础而有优质的源码是这款app的核心功能</font>，另外还会给大家分享一下我开发时遇到的种种问题，我把这些问题的解决方案都整理到了小经验这一模块里，供大家学习，经验虽小，用处却不小，在这里祝大家学习愉快！',3001,41,1,1),(2,2,1,'','','亲爱的鲁顺小同学，辛苦你了！',3,29,1,1),(3,2,1,'','','鲁顺小同学，你真是帮了我们大忙了，对一个初学者来说，就想多看看源码，网上源码虽多但是比较杂，不适合初学者！你搜集的源码既比较基础，又实用，好喜欢……',6,44,1,1),(4,7,1,'','','超喜欢小经验这一个版块，我敢打赌，初学者肯定会遇到这些问题的，解决方法超有效！',2,16,1,1),(5,1,1,'','','不好意思啊，大家，＂发动态＂这一个模块本可以完全能发图片的，但由于效果没有达到我理想中的要求，就暂时把这个功能屏蔽掉了，我一定会抓紧时间把这个功能补上的！相信我！',11,139,1,1),(6,2,1,'','','我们非常期待能发图片，最好能查看清晰的图，鲁顺小哥哥，一定要加油啊……',20,93,1,1),(17,1,1,'','mmexport1478792402361.png,mmexport1478792397042.png,IMG_20170122_163751.png,IMG_20170121_203743.png,IMG_20170122_163751.png','终于可以在京东工作了，好开心！我一定要好好努力，发几张工作环境的图片(*^ω^*)',40,105,1,1);
/*!40000 ALTER TABLE `qvalue` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `slidingmenu`
--

DROP TABLE IF EXISTS `slidingmenu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `slidingmenu` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `title` text NOT NULL,
  `desc` text NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `slidingmenu`
--

LOCK TABLES `slidingmenu` WRITE;
/*!40000 ALTER TABLE `slidingmenu` DISABLE KEYS */;
INSERT INTO `slidingmenu` VALUES (1,'精品课程侧滑菜单','精品课程侧滑菜单是从精品课程中提取出来的一个示例性项目。此侧滑菜单使用了一个有名的侧滑包，效果很好，很多大型软件也在使用。','2015-08-12 21:13:10','JPcehua.html','jingpincehua.png'),(2,'谷歌自带侧滑类','本项目来自极客学院。用了一年的sliding_menu侧滑包，还不知道官方自带了一个侧滑类，虽然效果不够炫丽，但是在功能上还能说的过去。用法比较简单。如果我没有猜错的话，大名鼎鼎的慕课网app就是用的这种侧滑菜单。','2015-08-14 05:26:34','gooleCeHua.html','googlecehua.png');
/*!40000 ALTER TABLE `slidingmenu` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `yuanma` VALUES (1,'列表（ListView）','','2015-08-12 10:59:04','list','cehuashanchu.png'),(2,'经典侧滑菜单','','2015-08-12 10:59:04','menu','cehuacaidan.png'),(3,'一起走进画廊','','2015-08-12 10:59:04','advzb','advzhanban.png'),(4,'高仿精品项目','','2015-08-12 10:59:04','gaofang','gaofang.png'),(5,'含服务端精品','','2015-08-12 10:59:04','hserver','qiushibaike.png'),(6,'<font color=\'red\'>今日推荐</font>','','2015-08-12 11:26:15','recommend','lushun.jpg');
...
-- Dump completed on 2017-03-26 18:27:34
